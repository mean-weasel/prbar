...
assertIncludes(html, "Open on GitHub", "release GitHub action");
assertIncludes(html, "Included repos power Activity, Releases, and Cards.", "repo selection explanation");
